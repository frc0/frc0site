# First a Personal Note about why we even have analytics at all.

We are not collecting any personal data whatsoever, no one has an account, user's don't have profiles and we don't have any way to identify you. We are not selling your data to anyone, we are not using your data to target you with ads, we are not using your data to make money. We are not using your data to make any decisions about you. We are not using your data to make any decisions about anyone. We are not using your data to make any decisions about anything. We are not selling any items, do not plan to make money or even accept money as of 2/27/2023. If for some reason that does change this policy will be updated at that time.

<img src="/images/why.gif" style="width: 100%">

So, in order to see how many people visit the site, where (country, state and city is as much as we know), and what pages they visited (view counts only) and how long they stayed on the site (time on site) we use Google Analytics. We do not use any other analytics tools, we do not use any other tracking tools, we do not use any other data tracking methods or cookies. We just want to know how well the website is spreading to FRC teams, if we are making content that is engaging and what pages are the most popular and deserve focus from the editors. If you do not like any part of this you can install the [Google Analytics Opt-out Browser Add-on](https://tools.google.com/dlpage/gaoptout) and it will prevent Google Analytics from tracking your activity on our site.

If you are curious what google analytics is collecting you can read about it [here](https://www.woopra.com/google-analytics/what-data-does-google-analytics-collect#:~:text=Like%20many%20web%20analytics%20tools,set%20up%20individual%20user%20tracking.)
...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Mr. Siefen&#39;s Robot Emporium LLC, 24600 Frederick Pankow Blvd, Clinton Twp, MI 48036.
...
- __Website__ refers to FRC Zero, accessible from [https://FRCzero.org/](https://FRCzero.org/)
...
- By email: siefens.robot.emporium@gmail.com